...
class SimulationConfig(db.Model):
    ...
    initual_conditions = db.Column(db.JSON, nullable=False) # initial positions, velocities, etc.
...
class SimulationResult(db.Model):
    ...
    navigation_metrics = db.Column(db.JSON, nullable=False) # Route, time taken, distance travel, speed (avg, min, max), etc.
